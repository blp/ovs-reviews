...
/*
 * Drive the raft library for the model checker. Forked from tests/test-raft.c
 * On startup initiates connection to the model checker process, so that it may
 * then interpose on library calls.
 */
