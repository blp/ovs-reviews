 ...
 *
 *    - Initialized (result == NULL, progress == NULL): Executing the trigger
 ...
 *
 *    - Committing (result != NULL, progress != NULL): The transaction is
 ...
 *
 *    - Complete (result != NULL, progress == NULL): The transaction is done
