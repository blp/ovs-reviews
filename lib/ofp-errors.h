...
/* ## ---------- ## */
    ...
    /* NX1.0-1.1(1,534), NX1.2+(35).  Closure is stale: Open vSwitch process
     * has been restarted or bridge has been destroyed since closure was
     * generated, or closure is the wrong Open vSwitch instance. */
    OFPERR_NXR_STALE,
};
